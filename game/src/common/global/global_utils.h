...
enum GLOBAL_STATUS {
	...
	GLOBAL_STATUS_STRENGTH_DEPLETE    =  1,
	GLOBAL_STATUS_VIGOR_RAISE         =  2,
	GLOBAL_STATUS_VIGOR_DEPLETE       =  3,
	GLOBAL_STATUS_FORTITUDE_RAISE     =  4,
	GLOBAL_STATUS_FORTITUDE_DEPLETE   =  5,
	GLOBAL_STATUS_PROTECTION_RAISE    =  6,
	GLOBAL_STATUS_PROTECTION_DEPLETE  =  7,
	GLOBAL_STATUS_AGILITY_RAISE       =  8,
	GLOBAL_STATUS_AGILITY_DEPLETE     =  9,
	GLOBAL_STATUS_EVADE_RAISE         = 10,
	GLOBAL_STATUS_EVADE_DEPLETE       = 11,
