	...
	[
		class_<MapMode, hoa_mode_manager::GameMode>("MapMode")
			...
			.enum_("constants") [
				...
				// Map contexts
				value("CONTEXT_NONE", CONTEXT_NONE),
				value("CONTEXT_01", CONTEXT_01),
				value("CONTEXT_02", CONTEXT_02),
				value("CONTEXT_03", CONTEXT_03),
				value("CONTEXT_04", CONTEXT_04),
				value("CONTEXT_05", CONTEXT_05),
				value("CONTEXT_06", CONTEXT_06),
				value("CONTEXT_07", CONTEXT_07),
				value("CONTEXT_08", CONTEXT_08),
				value("CONTEXT_09", CONTEXT_09),
				value("CONTEXT_10", CONTEXT_10),
				value("CONTEXT_11", CONTEXT_11),
				value("CONTEXT_12", CONTEXT_12),
				value("CONTEXT_13", CONTEXT_13),
				value("CONTEXT_14", CONTEXT_14),
				value("CONTEXT_15", CONTEXT_15),
				value("CONTEXT_16", CONTEXT_16),
				value("CONTEXT_17", CONTEXT_17),
				value("CONTEXT_18", CONTEXT_18),
				value("CONTEXT_19", CONTEXT_19),
				value("CONTEXT_20", CONTEXT_20),
				value("CONTEXT_21", CONTEXT_21),
				value("CONTEXT_22", CONTEXT_22),
				value("CONTEXT_23", CONTEXT_23),
				value("CONTEXT_24", CONTEXT_24),
				value("CONTEXT_25", CONTEXT_25),
				value("CONTEXT_26", CONTEXT_26),
				value("CONTEXT_27", CONTEXT_27),
				value("CONTEXT_28", CONTEXT_28),
				value("CONTEXT_29", CONTEXT_29),
				value("CONTEXT_30", CONTEXT_30),
				value("CONTEXT_31", CONTEXT_31),
				value("CONTEXT_32", CONTEXT_32),
				value("CONTEXT_ALL", CONTEXT_ALL),
				// Object types
