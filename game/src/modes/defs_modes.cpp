...
void BindModesToLua()
{
	...
	[
		class_<MapMode, hoa_mode_manager::GameMode>("MapMode")
			...
			.def_readonly("camera_sprite", &MapMode::_camera_sprite)
			...
			.def("SetCamera", (void(MapMode::*)(private_map::VirtualSprite*, uint16))&MapMode::SetCamera)
			.def("MoveCameraSprite", (void(MapMode::*)(uint16, uint16))&MapMode::MoveCameraSprite)
			.def("MoveCameraSprite", (void(MapMode::*)(uint16, uint16, uint16))&MapMode::MoveCameraSprite)
			.def("IsCameraOnCameraSprite", &MapMode::IsCameraOnCameraSprite)
