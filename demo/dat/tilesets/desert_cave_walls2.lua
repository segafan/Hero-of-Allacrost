...
desert_cave_walls2 = ns;
setfenv(1, ns);

file_name = "dat/tilesets/desert_cave_walls2.lua"
image = "img/tilesets/desert_cave_walls2.png"
num_tile_cols = 16
num_tile_rows = 16
