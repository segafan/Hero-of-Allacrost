...
function CreateSprites()
	...
	Map:MoveVirtualFocus(group_start_x, group_start_y);
	Map.virtual_focus:SetMovementSpeed(hoa_map.MapMode.SLOW_SPEED);
...
function CreateEvents()
	...
	event = hoa_map.PathMoveSpriteEvent.Create(34, Map.virtual_focus, march_distance, 0);
	event:SetRelativeDestination(true);
