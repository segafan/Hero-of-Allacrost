...
//			.def("GetYPosition", &MapObject::GetYPosition)
	...
	[
		class_<MapDialogue, hoa_common::CommonDialogue>("MapDialogue")
			...
			.def("AddLineTimed", (void(MapDialogue::*)(std::string, uint32, uint32))&MapDialogue::AddLineTimed)
			.def("AddLineTimed", (void(MapDialogue::*)(std::string, uint32, int32, uint32))&MapDialogue::AddLineTimed)
			.def("AddLineEvent", (void(MapDialogue::*)(std::string, uint32, uint32))&MapDialogue::AddLineEvent)
			.def("AddLineEvent", (void(MapDialogue::*)(std::string, uint32, int32, uint32))&MapDialogue::AddLineEvent)
			.def("AddLineTimedEvent", (void(MapDialogue::*)(std::string, uint32, uint32, uint32))&MapDialogue::AddLineTimedEvent)
			.def("AddLineTimedEvent", (void(MapDialogue::*)(std::string, uint32, int32, uint32, uint32))&MapDialogue::AddLineTimedEvent)
			...
			.def("AddOptionEvent", (void(MapDialogue::*)(std::string, uint32))&MapDialogue::AddOptionEvent)
			.def("AddOptionEvent", (void(MapDialogue::*)(std::string, int32, uint32))&MapDialogue::AddOptionEvent)
