...
////////////////////////////////////////////////////////////////////////////////
// MapPropertiesDialog class -- all methods
////////////////////////////////////////////////////////////////////////////////
	...
	QDialog(parent, (const char*)name)
{
	...
	// Loop through all files in the tileset directory. Start the loop at 2 to skip over the
	// present and parent working directories ("." and "..")
	for (uint32 i = 2; i < tileset_dir.count(); i++) {
		...
		if (prop) {
			...
			// Iterate through the names of the tabs to see which ones in the list are already present and set their checkbox appropriately.
...
void MapPropertiesDialog::_EnableOKButton() {
	...
	// If this point is reached, no tilesets are checked. Disable the OK button.
	_ok_pbut->setEnabled(false);
}

////////////////////////////////////////////////////////////////////////////////
// MusicDialog class -- all methods
////////////////////////////////////////////////////////////////////////////////
	...
	: QDialog(parent, name)
{
	...
	// Iterate through all files in the music directory and add those not in use to the available list
	for (unsigned int i = 0; i < music_dir.count(); i++) {
		// Only look for *.ogg files that are not already used by the map
		if (music_dir[i].contains(".ogg") && _used_music_list->findItems(music_dir[i], Qt::MatchContains).empty())
...
////////////////////////////////////////////////////////////////////////////////
// ContextPropertiesDialog class -- all methods
////////////////////////////////////////////////////////////////////////////////
