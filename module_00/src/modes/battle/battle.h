...
*/
    ...
    public:
        ActorEffect (private_battle::Actor * const AHost,
		     std::string AEffectName, StatusSeverity AHowSevere,
...
*/
    ...
    public:
        Actor (BattleMode * ABattleMode, uint32 AXLocation,
	       uint32 AYLocation);
	...
	hoa_global::GlobalAttackPoint * >GetAttackPoints () const = 0;
	...
	_y_origin = y;
      ...
      const double GetXLocation () const
      {
	return _x_location;
      }
      const double GetYLocation () const
      {
	return _y_location;
      }
...
*/
    ...
    public:
      PlayerActor (hoa_global::GlobalCharacter * const AWrapped,
      ...
      const std::vector <
	hoa_global::GlobalAttackPoint * >GetAttackPoints () const;
    ...
    public:
      EnemyActor (hoa_global::GlobalEnemy AGlobalEnemy,
		  BattleMode * const ABattleMode, uint32 AXLoc, uint32 AYLoc);
       ~EnemyActor ();
      void Update (uint32 ATimeElapsed);
      void Draw ();
...
*/
    ...
    public:
        ScriptEvent (Actor * AHost, std::deque < Actor * >AArguments,
 ...
 *****************************************************************************/
  ...
  public:
    ...
    void RemoveScriptedEventsForActor (private_battle::Actor *
				       AActorToRemove);
    ...
    void SwapCharacters (private_battle::PlayerActor * AActorToRemove,
