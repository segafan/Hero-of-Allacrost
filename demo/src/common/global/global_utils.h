...
enum GLOBAL_STATUS {
	...
	GLOBAL_STATUS_HP_BOOST           =  0,
	GLOBAL_STATUS_HP_DRAIN           =  1,
	GLOBAL_STATUS_SP_BOOST           =  2,
	GLOBAL_STATUS_SP_DRAIN           =  3,
	GLOBAL_STATUS_STRENGTH_BOOST     =  4,
	GLOBAL_STATUS_STRENGTH_DRAIN     =  5,
	GLOBAL_STATUS_VIGOR_BOOST        =  6,
	GLOBAL_STATUS_VIGOR_DRAIN        =  7,
	GLOBAL_STATUS_FORTITUDE_BOOST    =  8,
	GLOBAL_STATUS_FORTITUDE_DRAIN    =  9,
	GLOBAL_STATUS_PROTECTION_BOOST   = 10,
	GLOBAL_STATUS_PROTECTION_DRAIN   = 11,
	GLOBAL_STATUS_AGILITY_BOOST      = 12,
	GLOBAL_STATUS_AGILITY_DRAIN      = 13,
	GLOBAL_STATUS_EVADE_BOOST        = 14,
	GLOBAL_STATUS_EVADE_DRAIN        = 15,
