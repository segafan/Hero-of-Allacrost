	...
	[
		class_<GameGlobal>("GameGlobal")
			...
			.enum_("constants") [
				...
				value("GLOBAL_STATUS_STRENGTH_DEPLETE", GLOBAL_STATUS_STRENGTH_DEPLETE),
				value("GLOBAL_STATUS_VIGOR_RAISE", GLOBAL_STATUS_VIGOR_RAISE),
				value("GLOBAL_STATUS_VIGOR_DEPLETE", GLOBAL_STATUS_VIGOR_DEPLETE),
				value("GLOBAL_STATUS_FORTITUDE_RAISE", GLOBAL_STATUS_FORTITUDE_RAISE),
				value("GLOBAL_STATUS_FORTITUDE_DEPLETE", GLOBAL_STATUS_FORTITUDE_DEPLETE),
				value("GLOBAL_STATUS_PROTECTION_RAISE", GLOBAL_STATUS_PROTECTION_RAISE),
				value("GLOBAL_STATUS_PROTECTION_DEPLETE", GLOBAL_STATUS_PROTECTION_DEPLETE),
				value("GLOBAL_STATUS_AGILITY_RAISE", GLOBAL_STATUS_AGILITY_RAISE),
				value("GLOBAL_STATUS_AGILITY_DEPLETE", GLOBAL_STATUS_AGILITY_DEPLETE),
				value("GLOBAL_STATUS_EVADE_RAISE", GLOBAL_STATUS_EVADE_RAISE),
				value("GLOBAL_STATUS_EVADE_DEPLETE", GLOBAL_STATUS_EVADE_DEPLETE),
				...
				value("GLOBAL_STATUS_PARALYSIS", GLOBAL_STATUS_STASIS),
